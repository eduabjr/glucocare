# Script PowerShell para baixar Gradle Wrapper 9.1

Write-Host "========================================" -ForegroundColor Green
Write-Host "BAIXANDO GRADLE WRAPPER 9.1" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
...
# Baixar Gradle Wrapper 9.1
Write-Host "Baixando gradle-wrapper.jar..." -ForegroundColor Cyan
try {
    $url = "https://services.gradle.org/distributions/gradle-9.1-wrapper.jar"
    $output = "android\gradle\wrapper\gradle-wrapper.jar"
    
    Invoke-WebRequest -Uri $url -OutFile $output -UseBasicParsing
    Write-Host "✅ Gradle Wrapper 9.1 baixado com sucesso!" -ForegroundColor Green
} catch {
    ...
    try {
        $url = "https://github.com/gradle/gradle/raw/v9.1.0/gradle/wrapper/gradle-wrapper.jar"
        Invoke-WebRequest -Uri $url -OutFile $output -UseBasicParsing
