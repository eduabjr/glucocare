    ...
    <View>
      <View style={styles.card}>
        ...
        <View style={styles.centerIcon}>
          <View style={styles.circleIcon}>
            <MaterialCommunityIcons name="cellphone" size={40} color={theme.primary} />
          </View>
        </View>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity style={styles.uploadBox} onPress={handleFileImport}>
          <MaterialCommunityIcons name="file-upload" size={48} color={theme.accent} />
      ...
      <View style={styles.row}>
        <View style={[styles.card, styles.halfCard]}>
          <View style={styles.cardHeader}>
            <MaterialIcons name="devices" size={22} color={theme.primary} />
  ...
  return (
    <FlatList
      ...
      renderItem={({ item }) => (
        ...
        >
          <MaterialIcons name="devices" size={20} color={theme.primary} />
...
const getStyles = (theme: any) => StyleSheet.create({
  ...
  listItem: { fontSize: 13, color: theme.text, marginBottom: 6 },
});
