...
/*
  OBS: No Expo managed, ainda não é possível usar Bluetooth real.
  Aqui usamos um "mock" para simular a conexão.
  Caso você precise de Bluetooth real no futuro: será necessário ejectar o projeto
  e usar libs como react-native-ble-plx.
*/
